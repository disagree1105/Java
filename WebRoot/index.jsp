...
<body>
	...
	<br>	<a class="large button blue" href="login.jsp">管理员登录</a>
		<a class="large button orange" href="login.jsp">用户登录</a>
		<a class="large button yellow" href="register.jsp">用户注册</a>
<br>

<br line-height:2pt><p><img src="image/head.png" width="1024" height="61"></p><br>
...
<div style="width:40%;height:500px;;float:left;"><fieldset>
						<legend>机票预订</legend>
						<p>
						...
						<div>
							<label for="start">起点城市</label> <input type="text"
								name="startCity" id="startCity" value="" size="20"
								maxlength="30" /> <br>
						</div>
						<div>
							<label for="end">终点城市</label> <input type="text"
								name="endCity" id="endCity" size="20" maxlength="15" />
							<br>
						</div>
						<div>
							<label for="date">出发日期</label>
							<input type="text" name="date"  id="date" onClick="new Calendar().show(this);" readonly="readonly"/>
						</div>
						<div>
...
<div style="width:50%;height:400px;float:right;"><div id="DB_gallery">
	...
	<div class="DB_imgSet">
		...
		<div class="DB_prevBtn"><img src="galleryImgs/prev_off.png" alt="上一页"/></div>

		<div class="DB_nextBtn"><img src="galleryImgs/next_off.png" alt="下一页"/></div>
	...
	<div class="DB_thumSet">
		...
		<ul class="DB_thumMove">
			...
			<li><a href="galleryImgs/pic1.jpg"><img src="galleryImgs/thum1.jpg" alt=""/></a></li>

			<li><a href="galleryImgs/pic2.jpg"><img src="galleryImgs/thum2.jpg" alt=""/></a></li>

			<li><a href="galleryImgs/pic3.jpg"><img src="galleryImgs/thum3.jpg" alt=""/></a></li>

			<li><a href="galleryImgs/pic4.jpg"><img src="galleryImgs/thum4.jpg" alt=""/></a></li>

			<li><a href="galleryImgs/pic5.jpg"><img src="galleryImgs/thum5.jpg" alt=""/></a></li>

			<li><a href="galleryImgs/pic6.jpg"><img src="galleryImgs/thum6.jpg" alt=""/></a></li>
		...
		<div class="DB_prevPageBtn"><img src="galleryImgs/prev_page.png" alt="上一页"/></div>

		<div class="DB_nextPageBtn"><img src="galleryImgs/next_page.png" alt="下一页"/></div>
...
<HR style="FILTER: alpha(opacity=100,finishopacity=0,style=3)" width="100%" color=#987cb9 SIZE=10>
<br>
<center><font color='#929293'>CopyRight &copy; 徐明绮，陈霁鹏,All Rights Reserved</font>
</body>
</html>
